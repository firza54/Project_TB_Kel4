                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Kelola Kategori</strong>
                        </div>
                        <div class="card-body">
                             <table class="table">
                <thead>
...
<a href="manage-category.php?del=<?php echo $row['ID'];?>" class="btn btn-danger" onClick="return confirm('Are you sure you want to delete?')">Hapus</a>
                  </td>
                </tr>
                <?php 
$cnt=$cnt+1;
