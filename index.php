...
<html lang="en">
    <head>
        ...
        <title>e-Parking Intan Bussines Center</title>
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="index.php">e-Parking Intan Bussines Center</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">e-Parking Intan Bussines Center</h1>
                <!-- Icon Divider-->
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>e-Parking Intan Bussines Center @ 2024</small></div>
        </div>
        <!-- Bootstrap core JS-->
